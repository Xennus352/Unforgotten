...
export function AddMilestoneModal({ visible, onClose, onSave }: Props) {
    ...
    >
      ...
      >
        ...
        <View style={styles.sheet}>
          ...
          <Text style={styles.subheading}>Save a moment you never want to forget</Text>
            ...
            <View style={styles.emojiRow}>
              {EMOJI_OPTIONS.map((option) => (
                <Pressable
                  ...
                  style={[
                    styles.emojiChip,
                    emoji === option && styles.emojiChipSelected,
                  ]}
                >
          ...
          <View style={styles.actions}>
            ...
            >
              {saving ? (
                ...
                <Text style={styles.saveText}>Save milestone</Text>
              )}
            </Pressable>
          </View>
        </View>
...
const styles = StyleSheet.create({
  ...
  backdrop: {
    ...
    backgroundColor: "rgba(90, 75, 80, 0.45)",
  },
  sheet: {
    maxHeight: "88%",
  ...
  handle: {
    ...
    height: 4,
    borderRadius: 2,
    backgroundColor: "rgba(90, 75, 80, 0.2)",
    marginBottom: 12,
  },
  heading: {
    fontSize: 22,
  ...
  input: {
    borderWidth: 1,
    borderColor: "rgba(255, 194, 209, 0.9)",
    borderRadius: 14,
